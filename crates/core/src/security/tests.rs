...
fn test_permission_engine_expiration() {
    ...
    store
        .plugins()
        .insert(&polyglid_config::plugin_registry::PluginRegistryEntry {
            id: pid.clone(),
            ...
            source: polyglid_config::plugin_registry::PluginSource::LocalPath(
    ...
    store
        ...
        .lock()
        .unwrap()
        .execute("UPDATE permissions SET expiration = 100", [])
        .unwrap();
