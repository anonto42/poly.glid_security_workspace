...
use super::models::{
    BottomTab, EditorTab, PendingPluginInfo, PluginCard, ResizeAxis, ScanReport, SettingsTab,
    TopBarAction, TrackFilter, WorkspaceLoadState, WorkspaceView,
};
...
pub(crate) struct AppState {
    ...
    pub(crate) plugin_install_path: Signal<String>,
    pub(crate) pending_install: Signal<Option<PendingPluginInfo>>,
    pub(crate) install_error: Signal<Option<String>>,
...
pub(crate) fn use_app_state() -> AppState {
    AppState {
        ...
        plugin_install_path: use_signal(String::new),
        pending_install: use_signal(|| None),
        install_error: use_signal(|| None),
